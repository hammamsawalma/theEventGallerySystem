                                                                ...
                                                                {lineItem.customizations.length > 0 && (
                                                                    <div className="pl-3 border-l-2 border-primary/20 text-xs mt-1 space-y-2">
                                                                        {lineItem.customizations.map((custom: any) => {
                                                                            ...
                                                                            return (
                                                                                <div key={custom.id} className="flex justify-between text-muted-foreground items-center gap-2">
                                                                                    <div className="flex items-center gap-2">
                                                                                        ...
                                                                                        <span className="whitespace-nowrap">+ {custom.quantityAdded}x {customDef?.name || 'Unknown Customization'}</span>
                                                                                    </div>
                                                                                    <span className="whitespace-nowrap">+${(custom.extraPrice * custom.quantityAdded).toFixed(2)}</span>
                                                                                </div>
                                                                            )
                                                                        })}
                                                                    </div>
